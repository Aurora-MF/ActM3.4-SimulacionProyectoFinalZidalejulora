...
setup(
    ...
    zip_safe=True,
    maintainer='Aurora Martinez | Zaida Lopez | Alejandro Velazquez | Julio Resendiz |',
    maintainer_email='A01709293@tec.mx | A01708755@tec.mx| A01709475@tec.mx | A01709375@tec.mx',
